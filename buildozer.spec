...
source.exclude_exts = pyc, pyo, exe, bat, spec, md, keystore

# (list) List of directory to exclude (leave empty to not exclude anything)
source.exclude_dirs = tests, bin, venv, .buildozer, .git, android-ndk, __pycache__, .idea, .vscode
...
android.keystore_password = Yigitali_Dev.091
android.keyalias = my-key-alias
android.keyalias_password = Yigitali_Dev.091
